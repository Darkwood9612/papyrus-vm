...
namespace OpcodesImplementation {
	...
	void arrayFindElement(VarValue& array, VarValue& result, VarValue& needValue, VarValue& startIndex);
	void arrayRFindElement(VarValue& array, VarValue& result, VarValue& needValue, VarValue& startIndex);
}